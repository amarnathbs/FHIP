...
export const merchantsIn = [
  ...
  m('zomato', 'Zomato', { merchant_type: 'other', category_key: 'food', subcategory_key: 'takeaway_food_delivery', mcc: '5814', mcc_confidence: 'medium', essential_discretionary: 'discretionary', website_domain: 'zomato.com', parent_company_name: 'Eternal Limited', aliases: ['ZOMATO'], notes: 'Zomato\'s parent entity was renamed Eternal Limited in 2024; the consumer-facing Zomato brand is unchanged.' }),
  ...
  m('jiohotstar', 'JioHotstar', { merchant_type: 'subscription', category_key: 'lifestyle', subcategory_key: 'entertainment_streaming_subscriptions', mcc: '4899', mcc_confidence: 'low', essential_discretionary: 'discretionary', subscription_possible: true, recurring_possible: true, typical_frequency: 'monthly', fixed_amount_expected: true, recurring_type: 'subscription', website_domain: 'jiohotstar.com', parent_company_name: 'Reliance / Disney joint venture', aliases: ['JIOHOTSTAR', 'DISNEY+ HOTSTAR', 'HOTSTAR'], notes: 'LOWER-CONFIDENCE ENTRY: Disney+ Hotstar and JioCinema were publicly reported to have merged into JioHotstar in 2025; the precise current brand/entity status could not be independently re-verified without live web access — see FDH2_RESEARCH_EVIDENCE.md.' }),
  ...
  m('byjus', "BYJU'S", { merchant_type: 'education', category_key: 'education', subcategory_key: 'tutoring', mcc: '8299', mcc_confidence: 'medium', essential_discretionary: 'discretionary', website_domain: 'byjus.com', parent_company_name: 'Think and Learn Pvt Ltd', aliases: ["BYJU'S", 'BYJUS'], notes: "LOWER-CONFIDENCE ENTRY: BYJU'S has been the subject of widely reported financial distress and insolvency proceedings from 2023 onward; included as a historically significant merchant for narrative-matching purposes, not as an assertion of current trading status." }),
