...
-- against production; it has been validated only against DEV/PGlite (see
-- scripts/db-rebuild-check/education_goal_linkage.mjs, 32/32 passing,
-- and scripts/egl_live_dev_security_probe.mjs, which reproduced the
-- pre-fix vulnerability live against DEV). A human must run this in
-- production and confirm the results.
-- =============================================================================
