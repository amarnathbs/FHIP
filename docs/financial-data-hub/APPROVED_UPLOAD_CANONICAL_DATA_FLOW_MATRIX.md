...
- **WP-03 / WP-04 (2026-09-27):** the Dashboard (`lib/services/dashboardData.ts`, `lib/engines/dashboard.ts`) and every `loadDashboard` consumer (Score, DNA, Resilience, Goals, Recommendations, AI context, section status, and the Forecast / Report loaders that call it) now read ONE `CanonicalFinancialSnapshot` per request. Closed in the field registry: **DC-01** (bank transaction dates, 4 entries), **GAP-01** (payslip bank-match key) and **GAP-09** (net pay). Also closed by these packages (no registry entry): DC-02, DC-03, DC-05, DC-06, DC-11, DC-12 (Dashboard), DC-14 (dashboard / score / resilience / DNA / goals), DC-15, DC-18 (DNA / goals), DC-19, EXP-G3, EXP-G6, EXP-G7 and G9 (consumer side). The Twin (DC-04), Forecast variance (DC-13) and Reports (DC-09 / DC-10) remain with WP-05 / WP-06.
