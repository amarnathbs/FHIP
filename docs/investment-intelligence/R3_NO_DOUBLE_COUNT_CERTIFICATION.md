...
- All 470 tests (364 pre-existing + 106 new) pass; see `R3_TESTING_AND_VERIFICATION.md` for the LIVE-DEV-blocked distinction (DB-level constraint enforcement itself is unverifiable until the migration is applied — honestly disclosed, not glossed over).
