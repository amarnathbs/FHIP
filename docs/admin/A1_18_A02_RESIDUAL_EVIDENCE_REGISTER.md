...
| PO5-2 (rename "General" nav group) | Needs PO decision | **Resolved in design** (`A1_06` §3 — split into Recommendations + Reference Data & Benchmarks); final labels still flagged `A1_19` PO-2 |
