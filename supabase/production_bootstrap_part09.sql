-- FHIP production bootstrap — PART 9 of 9
-- Currency addition, PDF export support, and baseline seed data (0021-0022 + seed.sql + seed_master_items.sql).

-- === migrations/0021_currencies_add_usd.sql ===
...
-- === migrations/0022_report_pdf_export.sql ===
