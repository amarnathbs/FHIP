...
-- (see seed_master_items.sql's own header discipline and 0066's deprecate-
...
-- migration (0069). No existing row's data is touched by adding these
...
alter table master_financial_items
  ...
  -- account-vs-contribution separation in migration 0071.
...
comment on column master_financial_items.requires_purchase_date is
  'Chunk 3a: hard-require a purchase_date for this catalogue item on save. Currently false for every row — see 0069''s population notes on why nothing is hard-required yet.';
