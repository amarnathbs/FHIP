-- Chunk 3a item 1: populate the category-metadata columns (0033) for the
...
-- rows added by migration 0037, which is a separate, later file). income/
-- expense/liability/insurance rows are intentionally left at 0033's
...
-- Collectables (deprecated misspelling, migration 0031) / collectibles /
...
-- migration — see migration 0036's new retirement_contributions table for
