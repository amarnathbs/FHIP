...
--
-- DISCIPLINE (matches migration 0066's own precedent exactly): additive
...
-- (unlike 0066, which also had to add a corrected-spelling row).
--
...
-- deletable — instead of silently disappearing (0066's own disclosed risk,
-- now resolved for both 0066 and every deprecation below).
--
...
--    here — Chunk 3a's migration 0069 already gave both the asset-side
...
--    handled by Chunk 1's migration 0066 and is NOT repeated here — see the
...
--    migration 0074's retirement_contributions backfill for the rows with
