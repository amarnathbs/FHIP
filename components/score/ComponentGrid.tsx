...
import { bandStatus } from './HealthScoreGauge';
...
function ComponentCard({ component }: { component: ComponentResult }) {
  ...
  const status = component.treatment === 'scored' ? bandStatus(component.statusBand) : 'neutral';
  return (
...
export function ComponentGrid({ components }: { components: ComponentResult[] }) {
  return (
