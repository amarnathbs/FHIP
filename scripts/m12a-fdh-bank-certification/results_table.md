...
| FDH-A11 | ADDITIVE — silent-omission probe | 100.00% | 100.00% | 100.00% | 66.67% | 1 | **YES** | **YES** |
| FDH-A12 | ADDITIVE — India / INR jurisdiction variant | 100.00% | 100.00% | 100.00% | 100.00% | 0 | no | no |
| **ALL 12** | — | **100.00%** | **100.00%** | **100.00%** | **92.50%** | **1** | **20.00%** | **8.33%** |

- unexplained economic omissions: **1**
- false accept rate: **20.00%** (1 of 5 must-not-be-acceptable cases)
- false canonical write rate: **8.33%** (1 of 12 cases)
